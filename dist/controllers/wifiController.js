...
exports.deleteWifi = exports.getWifi = exports.create = void 0;
...
function create(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield wifiServices.create(data, authorization);
        res.sendStatus(201);
    });
}
...
function getWifi(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const wifi = yield wifiServices.getById(id, authorization);
...
function deleteWifi(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield wifiServices.deleteWifi(id, authorization);
        res.sendStatus(200);
    });
}
